...
def get_comments_from_function(blob, function_name):
    code_snippet = ""
    if (function_name != ''):
...
def retrieve_comment_from_function(function_name,file_path):
    ...
    comments=get_comments(code_snippet)
    return comments
## retrieve comments from functions directly
...
##            print(docstring)
            ...
            function,comments = get_comments_from_function(blob, f.name)
            # print(function);
